...
const __as_pixiContainerX = (c) => Number(c.x) || 0;
const __as_pixiContainerY = (c) => Number(c.y) || 0;
const __as_pixiContainerSetX = (c, x) => { c.x = x; return 0; };
const __as_pixiContainerSetY = (c, y) => { c.y = y; return 0; };
const __as_pixiContainerWidth = (c) => Number(c.width) || 0;
const __as_pixiContainerHeight = (c) => Number(c.height) || 0;
const __as_pixiContainerParent = (c) => (c.parent == null ? None : Some(c.parent));
const __as_pixiContainerSetInteractiveChildren = (c, v) => { c.interactiveChildren = v; return 0; };
const __as_pixiContainerRemoveChildren = (c) => { c.removeChildren(); return 0; };
const __as_pixiContainerAddChildAt = (p, c, i) => { p.addChildAt(c, i); return 0; };
const __as_pixiContainerSetHitAreaCircle = (c, area) => { c.hitArea = area; return 0; };
const __as_pixiContainerScale = (c) => c.scale;
const __as_pixiContainerPivot = (c) => c.pivot;
const __as_pixiContainerAnchor = (c) => c.anchor;
const __as_pixiObservablePointSet = (p, x, y) => { p.set(x, y); return 0; };
const __as_pixiObservablePointX = (p) => Number(p.x) || 0;
const __as_pixiObservablePointY = (p) => Number(p.y) || 0;
const __as_pixiObservablePointSetX = (p, x) => { p.x = x; return 0; };
const __as_pixiObservablePointSetY = (p, y) => { p.y = y; return 0; };
const __as_pixiGraphicsCircle = (g, x, y, r) => { g.circle(x, y, r); return 0; };
const __as_pixiGraphicsRoundRect = (g, x, y, w, h, radius) => { g.roundRect(x, y, w, h, radius); return 0; };
const __as_pixiGraphicsStroke = (g, options) => { g.stroke(options); return 0; };
...
const __as_pixiTextAnchor = (t) => t.anchor;
const __as_pixiSpriteSetWidth = (s, w) => { s.width = w; return 0; };
const __as_pixiSpriteSetHeight = (s, h) => { s.height = h; return 0; };
const __as_pixiSpriteWidth = (s) => Number(s.width) || 0;
const __as_pixiSpriteHeight = (s) => Number(s.height) || 0;
const __as_pixiSpriteSetInteractive = (s, v) => { s.interactive = v; return 0; };
const __as_pixiSpritePosition = (s) => s.position;
const __as_pixiTextureWhite = () => globalThis.__as_pixi.Texture.WHITE;
const __as_pixiTickerDeltaTime = (t) => Number(t.deltaTime) || 0;
const __as_pixiTickerRemove = (t, cb) => { t.remove(cb); return 0; };
...
const __as_pixiEventPreventDefault = (e) => { if (e && typeof e.preventDefault === "function") e.preventDefault(); return 0; };
...
const __as_pixiUiFancyButtonOnPress = (b, cb) => { b.onPress.connect(cb); return 0; };
...
const __as_pixiUiSliderValue = (s) => Number(s.value) || 0;
const __as_pixiUiSliderSetValue = (s, v) => { s.value = v; return 0; };
const __as_pixiUiSliderAddChild = (s, child) => { s.addChild(child); return 0; };
const __as_pixiUiListAddChild = (l, child) => { l.addChild(child); return 0; };
const __as_pixiUiInputValue = (i) => String(i.value ?? "");
const __as_pixiUiInputSetValue = (i, v) => { i.value = v; return 0; };
...
const __as_pixiUiProgressBarProgress = (p) => Number(p.progress) || 0;
const __as_pixiUiProgressBarSetProgress = (p, v) => { p.progress = v; return 0; };
...
const __as_pixiSoundPlayOptions = (s, options) => { s.play(options); return 0; };
const __as_pixiSoundPauseAll = () => { globalThis.__as_pixi_sound_lib.pauseAll(); return 0; };
const __as_pixiSoundResumeAll = () => { globalThis.__as_pixi_sound_lib.resumeAll(); return 0; };
...
const __as_pixiSoundVolumeAll = () => Number(globalThis.__as_pixi_sound_lib.volumeAll) || 0;
const __as_pixiSoundSetVolumeAll = (vol) => { globalThis.__as_pixi_sound_lib.volumeAll = vol; return 0; };
const __as_pixiSoundFind = (name) => globalThis.__as_pixi_sound_lib.find(name);
const __as_pixiSoundPlayName = (name, options) => { globalThis.__as_pixi_sound_lib.play(name, options); return 0; };
...
let () =
  ...
  b "pixiContainerX"            (fun a -> Printf.sprintf "__as_pixiContainerX(%s)" (arg 0 a));
  b "pixiContainerY"            (fun a -> Printf.sprintf "__as_pixiContainerY(%s)" (arg 0 a));
  b "pixiContainerSetX"         (fun a -> Printf.sprintf "__as_pixiContainerSetX(%s, %s)" (arg 0 a) (arg 1 a));
  b "pixiContainerSetY"         (fun a -> Printf.sprintf "__as_pixiContainerSetY(%s, %s)" (arg 0 a) (arg 1 a));
  b "pixiContainerWidth"        (fun a -> Printf.sprintf "__as_pixiContainerWidth(%s)" (arg 0 a));
  b "pixiContainerHeight"       (fun a -> Printf.sprintf "__as_pixiContainerHeight(%s)" (arg 0 a));
  b "pixiContainerParent"       (fun a -> Printf.sprintf "__as_pixiContainerParent(%s)" (arg 0 a));
  b "pixiContainerSetInteractiveChildren" (fun a -> Printf.sprintf "__as_pixiContainerSetInteractiveChildren(%s, %s)" (arg 0 a) (arg 1 a));
  b "pixiContainerRemoveChildren" (fun a -> Printf.sprintf "__as_pixiContainerRemoveChildren(%s)" (arg 0 a));
  b "pixiContainerAddChildAt"   (fun a -> Printf.sprintf "__as_pixiContainerAddChildAt(%s, %s, %s)" (arg 0 a) (arg 1 a) (arg 2 a));
  b "pixiContainerSetHitAreaCircle" (fun a -> Printf.sprintf "__as_pixiContainerSetHitAreaCircle(%s, %s)" (arg 0 a) (arg 1 a));
  b "pixiContainerScale"        (fun a -> Printf.sprintf "__as_pixiContainerScale(%s)" (arg 0 a));
  b "pixiContainerPivot"        (fun a -> Printf.sprintf "__as_pixiContainerPivot(%s)" (arg 0 a));
  b "pixiContainerAnchor"       (fun a -> Printf.sprintf "__as_pixiContainerAnchor(%s)" (arg 0 a));
  b "pixiObservablePointSet"    (fun a -> Printf.sprintf "__as_pixiObservablePointSet(%s, %s, %s)" (arg 0 a) (arg 1 a) (arg 2 a));
  b "pixiObservablePointX"      (fun a -> Printf.sprintf "__as_pixiObservablePointX(%s)" (arg 0 a));
  b "pixiObservablePointY"      (fun a -> Printf.sprintf "__as_pixiObservablePointY(%s)" (arg 0 a));
  b "pixiObservablePointSetX"   (fun a -> Printf.sprintf "__as_pixiObservablePointSetX(%s, %s)" (arg 0 a) (arg 1 a));
  b "pixiObservablePointSetY"   (fun a -> Printf.sprintf "__as_pixiObservablePointSetY(%s, %s)" (arg 0 a) (arg 1 a));
  b "pixiGraphicsCircle"        (fun a -> Printf.sprintf "__as_pixiGraphicsCircle(%s, %s, %s, %s)" (arg 0 a) (arg 1 a) (arg 2 a) (arg 3 a));
  b "pixiGraphicsRoundRect"     (fun a -> Printf.sprintf "__as_pixiGraphicsRoundRect(%s, %s, %s, %s, %s, %s)" (arg 0 a) (arg 1 a) (arg 2 a) (arg 3 a) (arg 4 a) (arg 5 a));
  b "pixiGraphicsStroke"        (fun a -> Printf.sprintf "__as_pixiGraphicsStroke(%s, %s)" (arg 0 a) (arg 1 a));
  b "pixiGraphicsMoveTo"        (fun a -> Printf.sprintf "__as_pixiGraphicsMoveTo(%s, %s, %s)" (arg 0 a) (arg 1 a) (arg 2 a));
  b "pixiGraphicsLineTo"        (fun a -> Printf.sprintf "__as_pixiGraphicsLineTo(%s, %s, %s)" (arg 0 a) (arg 1 a) (arg 2 a));
  b "pixiGraphicsQuadraticCurveTo" (fun a -> Printf.sprintf "__as_pixiGraphicsQuadraticCurveTo(%s, %s, %s, %s, %s)" (arg 0 a) (arg 1 a) (arg 2 a) (arg 3 a) (arg 4 a));
  b "pixiTextAnchor"            (fun a -> Printf.sprintf "__as_pixiTextAnchor(%s)" (arg 0 a));
  b "pixiSpriteSetWidth"        (fun a -> Printf.sprintf "__as_pixiSpriteSetWidth(%s, %s)" (arg 0 a) (arg 1 a));
  b "pixiSpriteSetHeight"       (fun a -> Printf.sprintf "__as_pixiSpriteSetHeight(%s, %s)" (arg 0 a) (arg 1 a));
  b "pixiSpriteWidth"           (fun a -> Printf.sprintf "__as_pixiSpriteWidth(%s)" (arg 0 a));
  b "pixiSpriteHeight"          (fun a -> Printf.sprintf "__as_pixiSpriteHeight(%s)" (arg 0 a));
  b "pixiSpriteSetInteractive"  (fun a -> Printf.sprintf "__as_pixiSpriteSetInteractive(%s, %s)" (arg 0 a) (arg 1 a));
  b "pixiSpritePosition"        (fun a -> Printf.sprintf "__as_pixiSpritePosition(%s)" (arg 0 a));
  b "pixiTextureWhite"          (fun _ -> "__as_pixiTextureWhite()");
  b "pixiTickerDeltaTime"       (fun a -> Printf.sprintf "__as_pixiTickerDeltaTime(%s)" (arg 0 a));
  b "pixiTickerRemove"          (fun a -> Printf.sprintf "__as_pixiTickerRemove(%s, %s)" (arg 0 a) (arg 1 a));
  b "pixiAppRenderer"           (fun a -> Printf.sprintf "__as_pixiAppRenderer(%s)" (arg 0 a));
  b "pixiRendererResize"        (fun a -> Printf.sprintf "__as_pixiRendererResize(%s, %s, %s)" (arg 0 a) (arg 1 a) (arg 2 a));
  b "pixiAssetsInit"            (fun a -> Printf.sprintf "(await __as_pixiAssetsInit(%s))" (arg 0 a));
  b "pixiAssetsLoadBundle"      (fun a -> Printf.sprintf "(await __as_pixiAssetsLoadBundle(%s))" (arg 0 a));
  b "pixiAssetsBackgroundLoadBundle" (fun a -> Printf.sprintf "__as_pixiAssetsBackgroundLoadBundle(%s)" (arg 0 a));
  b "pixiEventPreventDefault"   (fun a -> Printf.sprintf "__as_pixiEventPreventDefault(%s)" (arg 0 a));
  (* ---- @pixi/ui (bindings #3) ---- *)
  ...
  b "pixiUiFancyButtonOnPress" (fun a -> Printf.sprintf "__as_pixiUiFancyButtonOnPress(%s, %s)" (arg 0 a) (arg 1 a));
  b "pixiUiFancyButtonOnDown"  (fun a -> Printf.sprintf "__as_pixiUiFancyButtonOnDown(%s, %s)" (arg 0 a) (arg 1 a));
  b "pixiUiFancyButtonOnHover" (fun a -> Printf.sprintf "__as_pixiUiFancyButtonOnHover(%s, %s)" (arg 0 a) (arg 1 a));
  b "pixiUiSliderValue"        (fun a -> Printf.sprintf "__as_pixiUiSliderValue(%s)" (arg 0 a));
  b "pixiUiSliderSetValue"     (fun a -> Printf.sprintf "__as_pixiUiSliderSetValue(%s, %s)" (arg 0 a) (arg 1 a));
  b "pixiUiSliderAddChild"     (fun a -> Printf.sprintf "__as_pixiUiSliderAddChild(%s, %s)" (arg 0 a) (arg 1 a));
  b "pixiUiListAddChild"       (fun a -> Printf.sprintf "__as_pixiUiListAddChild(%s, %s)" (arg 0 a) (arg 1 a));
  b "pixiUiInputValue"         (fun a -> Printf.sprintf "__as_pixiUiInputValue(%s)" (arg 0 a));
  b "pixiUiInputSetValue"      (fun a -> Printf.sprintf "__as_pixiUiInputSetValue(%s, %s)" (arg 0 a) (arg 1 a));
  b "pixiUiInputOnEnter"       (fun a -> Printf.sprintf "__as_pixiUiInputOnEnter(%s, %s)" (arg 0 a) (arg 1 a));
  b "pixiUiInputOnChange"      (fun a -> Printf.sprintf "__as_pixiUiInputOnChange(%s, %s)" (arg 0 a) (arg 1 a));
  b "pixiUiProgressBarProgress" (fun a -> Printf.sprintf "__as_pixiUiProgressBarProgress(%s)" (arg 0 a));
  b "pixiUiProgressBarSetProgress" (fun a -> Printf.sprintf "__as_pixiUiProgressBarSetProgress(%s, %s)" (arg 0 a) (arg 1 a));
  ...
  b "pixiSoundIsPlaying"  (fun a -> Printf.sprintf "__as_pixiSoundIsPlaying(%s)" (arg 0 a));
  b "pixiSoundDuration"   (fun a -> Printf.sprintf "__as_pixiSoundDuration(%s)" (arg 0 a));
  b "pixiSoundPlayOptions"(fun a -> Printf.sprintf "__as_pixiSoundPlayOptions(%s, %s)" (arg 0 a) (arg 1 a));
  b "pixiSoundPauseAll"   (fun _ -> "__as_pixiSoundPauseAll()");
  b "pixiSoundResumeAll"  (fun _ -> "__as_pixiSoundResumeAll()");
  b "pixiSoundMuteAll"    (fun _ -> "__as_pixiSoundMuteAll()");
  b "pixiSoundUnmuteAll"  (fun _ -> "__as_pixiSoundUnmuteAll()");
  b "pixiSoundVolumeAll"  (fun _ -> "__as_pixiSoundVolumeAll()");
  b "pixiSoundSetVolumeAll" (fun a -> Printf.sprintf "__as_pixiSoundSetVolumeAll(%s)" (arg 0 a));
  b "pixiSoundFind"       (fun a -> Printf.sprintf "__as_pixiSoundFind(%s)" (arg 0 a));
  b "pixiSoundPlayName"   (fun a -> Printf.sprintf "__as_pixiSoundPlayName(%s, %s)" (arg 0 a) (arg 1 a));
