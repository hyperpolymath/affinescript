...
* *Developers / contributors* — this guide, link:../wiki/compiler/architecture.md[compiler architecture], link:decisions/[ADRs], link:governance/../.github/CONTRIBUTING.md[contributing].
...
* link:governance/../.github/CONTRIBUTING.md[Contributing Guide] - How to contribute
...
1. Read link:governance/../.github/CONTRIBUTING.md[Contributing Guide]
