...
This roadmap outlines the path from current state (lexer {plus} parser)
...
*Files*: `lib/unify.ml`, `lib/union++_++find.ml`
...
*Files*: `lib/effect.ml`, `lib/effect++_++infer.ml`
...
*Files*: `lib/smt.ml`, `lib/smt++_++translate.ml`
...
*Duration*: Ongoing (8{plus} weeks initial)
...
*Duration*: Ongoing (10{plus} weeks initial)
...
* [ ] 100{plus} test programs type check correctly
...
* [ ] 10{plus} community packages
* [ ] 3{plus} production users
