...
* The `claude/mpl-2-0-migration` (#384) license sweep (note: target is now MPL-2.0 — *check this is actually intended*; the standing estate policy in CLAUDE.md says MPL-2.0)
