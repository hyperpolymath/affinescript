...
WASI runtime support (lib/wasi++_++runtime.ml) - ✅ FFI layer
...
*WASI Runtime (lib/wasi++_++runtime.ml):* - fd++_++write for
stdout/stderr - Basic string and integer printing - No file I/O,
networking, or system calls - No hardware acceleration
