...
2026-07-25. Residual WASI slices live as independent follow-ups (#485 S5
filesystem, #486 S6c default-flip, #487 sockets); satellite remainder is
#56. Stage E is now the frontier.
...
GitHub index #175 is closed (8/8 original sub-issues complete, owner close
2026-09-21); severity/blocked-by also in
link:TECH-DEBT.adoc[TECH-DEBT.adoc]. Residual WASI work is #485/#486/#487;
