...
#181 INT-04-JSR, #182 INT-07, #183 INT-08). The GitHub ticket itself is a
closed index (owner close 2026-09-21); this ledger remains the durable
index. Residual WASI work lives as independent follow-ups (#485 S5
filesystem, #486 S6c default-flip, #487 socket recv/send/accept);
satellite remainder is #56.
====
