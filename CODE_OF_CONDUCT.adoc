...
AffineScript a harassment-free experience for everyone, regardless of
...
[arabic]
. You will receive acknowledgment within *7 days*
...
* Appeals are reviewed after consultation with an uninvolved party where
possible
...
* Open a
https://github.com/hyperpolymath/affinescript/discussions[Discussion]
