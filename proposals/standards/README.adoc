...
existing /TS exemption material, since it governs the same
...
"package management: Guix primary, Guix fallback, Deno for JS deps"
material).
...
*github-only* network: package registries (`crates.io`, ``,
