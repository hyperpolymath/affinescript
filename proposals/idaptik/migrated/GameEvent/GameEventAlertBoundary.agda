...
module GameEventAlertBoundary where
...
--   c2 = Orange
--   c3 = Red
--   c4 = BelowGreen   (out-of-band / clamp entry)
data Host : Set where
  c0 c1 c2 c3 c4 : Host
...
-- same code 0.
--   c0 = Green
--   c4 = BelowGreen  (out-of-band / clamp)
-- Distinctness is constructor disjointness; the shared code is refl.
c0≢c4 : c0 ≢ c4
c0≢c4 ()

collision : c0 ≢ c4 × code c0 ≡ code c4
collision = c0≢c4 , refl
